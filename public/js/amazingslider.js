...
(function ($) {
    $.fn.ashtml5lightbox = function (options) {
        ...
        var ELEM_TYPE = 0, ELEM_HREF = 1, ELEM_TITLE = 2, ELEM_GROUP = 3, ELEM_WIDTH = 4, ELEM_HEIGHT = 5, ELEM_HREF_WEBM = 6, ELEM_HREF_OGG = 7, ELEM_THUMBNAIL =
            8, ELEM_DESCRIPTION = 9, ELEM_DIV = 10;
        inst.readData = function () {
            inst.each(function () {
                ...
                inst.elemArray.push(new Array(fileType, $this.attr("href"), $this.attr("title"), $this.data("group"), $this.data("width"),
                    $this.data("height"), $this.data("webm"), $this.data("ogg"), $this.data("thumbnail"), $this.data("description")))
            })
        };
        inst.createMarkup = function () {
            ...
            styleCss +=
                ".html5-description " + inst.options.descriptioncss;
        ...
        inst.showSWF = function (elem) {
            var dataW =
                elem[ELEM_WIDTH] ? elem[ELEM_WIDTH] : DEFAULT_WIDTH;
            ...
            inst.resizeLightbox(dataW, dataH, true, function () {
                ...
                inst.embedFlash($("#html5lightbox-swf"), elem[ELEM_HREF],
                    "window", {width: dataW, height: dataH});
                inst.$elem.show();
                inst.showData()
            })
        };
        inst.showVideo = function (elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function () {
                ...
                var isHTML5 = false;
                if (inst.options.isIE678 || elem[ELEM_TYPE] == 8 || inst.options.isIE9 && inst.options.useflashonie9 || inst.options.isIE10 && inst.options.useflashonie10 || inst.options.isIE11 && inst.options.useflashonie11)isHTML5 = false; else if (inst.options.isMobile)isHTML5 = true; else if ((inst.options.html5player || !inst.options.flashInstalled) && inst.options.html5VideoSupported)if (!inst.options.isFirefox && !inst.options.isOpera || (inst.options.isFirefox || inst.options.isOpera) && (elem[ELEM_HREF_OGG] || elem[ELEM_HREF_WEBM]))isHTML5 =
                    true;
                if (isHTML5) {
        ...
        inst.showYoutubeVimeo = function (elem) {
            var dataW = elem[ELEM_WIDTH] ? elem[ELEM_WIDTH] : DEFAULT_WIDTH;
            var dataH =
                elem[ELEM_HEIGHT] ? elem[ELEM_HEIGHT] : DEFAULT_HEIGHT;
            var sizeObj = inst.calcElemSize({w: dataW, h: dataH}, true);
            dataW = sizeObj.w;
            dataH = sizeObj.h;
            inst.resizeLightbox(dataW, dataH, true, function () {
        ...
        inst.showWeb = function (elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function () {
                ...
                inst.$image.css({
                    width: sizeObj.w,
                    height: sizeObj.h
                }).html("<div id='html5lightbox-web' style='display:block;width:100%;height:100%;" + (inst.options.isIOS ? "-webkit-overflow-scrolling:touch;overflow-y:scroll;" : "") + "'></div>").show();
        ...
        inst.calcElemSize = function (sizeObj, keepratio) {
            ...
            if (sizeObj.w > w0) {
                if (keepratio)sizeObj.h =
                    Math.round(sizeObj.h * w0 / sizeObj.w);
                sizeObj.w = w0
            }
            return sizeObj
        };
...
(function ($) {
    $.fn.amazingslider = function (options) {
            ...
            initData: function (onSuccess) {
                ...
                if (ASYouTubeIframeAPIReady && !ASPlatforms.isIE6() && !ASPlatforms.isIE7() && !ASPlatforms.isIOS() && !ASPlatforms.isAndroid()) {
                    ...
                    params = $.extend({}, params, {
                        "html5": 1, "autoplay": 1, "rel": 0, "autohide": 1,
                        "wmode": "transparent"
                    });
                ...
                this.container.bind("amazingslider.switchtext", function (event, prev, cur) {
                    ...
                    if (instance.textoptions.textstyle == "static") {
                        ...
                        switch (instance.textoptions.textpositionstatic) {
                            case "top":
                                $textWrapper.css({
                                    left: "0px",
                                    top: "0px", "margin-top": instance.textoptions.textpositionmarginstatic + "px"
                                });
                                break;
                            case "bottom":
                                $textWrapper.css({
                    ...
                    if (instance.textoptions.textstyle == "static") {
                        ...
                        if (instance.elemArray[cur][ELEM_BUTTON].length >
                            0)$button.html(instance.elemArray[cur][ELEM_BUTTON]).css({"display": "block"}); else $button.css({"display": "none"}).html("");
                ...
                if (this.options.navthumbnavigationstyle != "auto") {
                    ...
                    if (this.options.navmultirows) {
                        ...
                        if (this.options.navdirection ==
                            "vertical")$bulletWrapper.css({"margin-top": 0}); else $bulletWrapper.css({"margin-left": "auto"})
                    }
                }
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $(imgLoader).load(function () {
                        if (instance.options.navthumbstyle != "textonly") {
                            ...
                            if (instance.options.navshowplayvideo && (instance.elemArray[index][ELEM_VIDEO].length > 0 || instance.elemArray[index][ELEM_LINK] && instance.elemArray[index][ELEM_LIGHTBOX] && instance.checkVideoType(instance.elemArray[index][ELEM_LINK]) >
                                0))$bullet.append("<div style='display:block;position:absolute;margin-left:0;margin-top:0;width:" + instance.options.navimagewidth + "px;height:" + instance.options.navimageheight + "px;" + 'background:url("' + instance.options.skinsfolder + instance.options.navplayvideoimage + '") no-repeat center center;' + "' ></div>")
                        }
                        if (instance.options.navthumbstyle != "imageonly") {
                            var thumbtitle = "<div class='amazingslider-bullet-text-" + instance.id + "' style='display:block;position:absolute;overflow:hidden;";
                            if (instance.options.navthumbstyle ==
                                "imageandtitle")thumbtitle += "margin-left:0px;margin-top:" + instance.options.navimageheight + "px;width:" + instance.options.navimagewidth + "px;height:" + instance.options.navthumbtitleheight + "px;"; else if (instance.options.navthumbstyle == "imageandtitledescription")thumbtitle += "margin-left:" + instance.options.navimagewidth + "px;margin-top:0px;width:" + instance.options.navthumbtitlewidth + "px;height:" + instance.options.navimageheight + "px;"; else if (instance.options.navthumbstyle == "textonly")thumbtitle += "margin-left:0px;margin-top:0px;width:" +
        ...
        this.each(function () {
            ...
            if ($(this).data("textformat") && typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== "undefined")if ($(this).data("textformat")in AMAZINGSLIDER_TEXT_EFFECT_FORMATS)this.options = $.extend({}, AMAZINGSLIDER_TEXT_EFFECT_FORMATS[$(this).data("textformat")],
                this.options);
            ...
            var defaultOptions = {
                ...
                kenburns: {
                    fadeduration: 3E3,
                    duration: 5E3, effects: "zoomin,zoomout", scale: 1.1, easing: "easeOutCubic", checked: true
                },
                threedhorizontal: {
                    checked: true,
                    effectdirection: 0,
